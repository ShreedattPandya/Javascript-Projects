const questions = [
    {
        ...
        answers:[
            ...
            {text: "Pagani Huayra", correct: false}, 
        ]
    },
    {
        question: "App with the biggest number of customers?",
        answers:[
...
let currentQuestionIndex = 0; //By default questions numbering
let score = 0;

function startQuiz(){
    currentQuestionIndex = 0;
    score = 0;
    nextButton.innerHTML = "Next"; //Since after all questions replace it with FINISH
    showQuestion();
}
